                                ...
                                <table class="table align-items-center mt-3 mb-0">
                                    ...
                                    @foreach($data as $keluar)
                                        <tr >
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                {{ $keluar->kode_klasifikasi }}
                                            </td>
                                            <td>
                                                <div class="table-data-feature">
                        
                                                    <a href="/surat/keluar/{{ $keluar->id }}/" class="item bg-info" data-toggle="tooltip" data-placement="top" title="Lihat">
                                                        <i class="fa-solid fa-eye fa-sm"></i>
                                                    </a>

                                                    <a href="/surat/keluar/{{ $keluar->id }}/edit" class="item bg-warning" data-toggle="tooltip" data-placement="top" title="Edit">
