            ...
            <div class="card card-body mx-3 mx-md-4 mt-4">
                ...
                <div class="card card-plain h-100">
                    <div class="card-header pb-0 p-3">
                        <div class="row">
                            <div class="col-md-8 d-flex align-items-center">
                                <h6 class="mb-3">Edit Surat Keluar</h6>
                            </div>
                        </div>
                    </div>
                    <div class="card-body p-3">
                        ...
                        @endif
                        <form action="/surat/keluar/{{ $keluar->id }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-12 col-md-6 col-lg-6">
                                    <x-input-form :value="$keluar->nomor_surat" name="nomor_surat"
                                        label="Nomor Surat"/>
                                </div>

                                <div class="col-sm-12 col-12 col-md-6 col-lg-6">
                                    <x-input-form :value="$keluar->nomor_agenda" name="nomor_agenda"
                                        label="Nomor Agenda"/>
                                </div>

                                <div class="col-sm-12 col-12 col-md-6 col-lg-6">
                                    <x-input-form :value="$keluar->tujuan" name="tujuan" label="Tujuan"/>
                                </div>
                                <div class="col-sm-12 col-12 col-md-6 col-lg-6">
                                    <x-input-form :value="date('Y-m-d', strtotime($keluar->tanggal_surat))" name="tanggal_surat"
                                        label="Tanggal Surat"
                                                  type="date"/>
                                </div>
                                <div class="col-sm-12 col-12 col-md-8 col-lg-8">
                                    <x-input-textarea-form :value="$keluar->isi_ringkasan" name="isi_ringkasan"
                                        label="Isi Ringkasan"/>
                                </div>
                                <div class="col-sm-12 col-12 col-md-4 col-lg-4">
                                    <x-input-textarea-form :value="$keluar->keterangan" name="keterangan"
                                        label="Keterangan"/>
                                </div>
                                ...
                                <div class="col-sm-12 col-12 col-md-6 col-lg-4">
                                    <input type="hidden" name="oldLampiran" value="{{ $keluar->lampiran }}">
