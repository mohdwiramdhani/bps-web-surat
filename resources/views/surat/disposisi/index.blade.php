                        ...
                        <div class="card-header pb-0 p-3">
                            <div class="row">
                                ...
                                <div class="col-4 text-end">
                                        <a href="{{ route('surat.disposisi.create', $masuk) }}" class="btn bg-gradient-dark mb-0">
                                        ...
                                        <tr id="table-row-{{ $disposisi->token }}">
                                            ...
                                            <td>
                                                <div class="table-data-feature">
                                                    ...
                                                    <a href="{{ route('surat.disposisi.show', [$masuk, $disposisi]) }}" class="item bg-info" data-toggle="tooltip" data-placement="top" title="Lihat">
                                                        <i class="fa-solid fa-eye fa-sm"></i>
                                                    </a>

                                                    <a href="{{ route('surat.disposisi.edit', [$masuk, $disposisi]) }}" class="item bg-warning" data-toggle="tooltip" data-placement="top" title="Edit">
                                                        <i class="fa-solid fa-pencil fa-sm"></i>
                                                    </a>
    
                                                    <form action="{{ route('surat.disposisi.destroy', [$masuk, $disposisi]) }}" class="d-inline" method="post">
                                                    @csrf
                                                        @method('DELETE')
