...
class DisposisiController extends Controller
{
    ...
    public function index(Request $request,Masuk $masuk)
   {
    ...
    public function views(Request $request,Disposisi $disposisi)
    {
    ...
    public function store(StoreDisposisiRequest $request, Masuk $masuk)
    {
        ...
        $base_url = 'https://456c-180-247-46-122.ap.ngrok.io/';
    ...
    public function trigger($token, )
    {
        ...
        DB::table('disposisis')
            ...
            $message = 'Penerima ' . $penerima . ' dengan nomor surat ' . $nomor_surat . ' sudah dibaca.';
            
            $notifikasi = new NotifikasiDisposisi;
            $notifikasi->pesan = $message;
            $notifikasi->link = '/surat/' . $surat_id . '/disposisi/' . $disposisi_id;
            $notifikasi->disposisi_token = $token;
